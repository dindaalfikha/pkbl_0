			...
			<div class="sidebar-content">
				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item">
							<a href="{{route('admin.admin_unit')}}" class="nav-link">
								<i class="icon-user"></i>
								<span>
									Admin Management
								</span>
						...
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="fa fa-suitcase"></i> <span>Proposal</span></a>

							<ul class="nav nav-group-sub" data-submenu-title="User Manangement">
								<li class="nav-item"><a href="{{route('admin.add_users')}}" class="nav-link"><i class="fa fa-map"></i> Pengajuan Proposal</a></li>
								<li class="nav-item"><a href="{{route('admin.area.management')}}" class="nav-link"><i class="fa fa-map"></i> Cek status Proposal</a></li>
							</ul>
						</li>								
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="User Manangement">
								<li class="nav-item"><a href="{{route('admin.area.management')}}" class="nav-link"><i class="fa fa-map"></i> Unit Management</a></li>
								<li class="nav-item"><a href="{{route('admin.usaha.management')}}" class="nav-link"><i class="fa fa-briefcase"></i> Sektor Usaha Management</a></li>
								<li class="nav-item"><a href="{{route('admin.usaha.jenis')}}" class="nav-link"><i class="fa fa-briefcase"></i> Jenis Usaha Management</a></li>
							</ul>
						</li>
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="User Manangement">
								<li class="nav-item"><a href="{{route('admin.add_users')}}" class="nav-link"><i class="icon-user-plus"></i> Add User Account</a></li>
								<li class="nav-item"><a href="{{url('/admin/users')}}" class="nav-link"><i class="icon-user"></i> Client accounts</a></li>
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Loan management">
								<li class="nav-item"><a href="{{route('admin.add.loan')}}" class="nav-link"><i class="icon-add"></i>Tambah Loan</a></li>
								<li class="nav-item"><a href="{{route('admin.loan.hold')}}" class="nav-link"><i class="icon-watch"></i>On Hold</a></li>
								<li class="nav-item"><a href="{{route('admin.loan.approval')}}" class="nav-link"><i class="fa fa-check"></i>Awaiting Approval</a></li>
								<li class="nav-item"><a href="{{route('admin.loan.pending')}}" class="nav-link"><i class="icon-spinner2 spinner"></i>Awaiting Payback</a></li>
								<li class="nav-item"><a href="{{route('admin.loan.completed')}}" class="nav-link"><i class="icon-cup2"></i>Done</a></li>
							</ul>
						</li>
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="fa fa-suitcase"></i> <span>Hasil Survey</span></a>
							<ul class="nav nav-group-sub" data-submenu-title="User Manangement">
								<li class="nav-item"><a href="{{route('admin.add_users')}}" class="nav-link"><i class="fa fa-map"></i>Upload hasil survey</a></li>
								<li class="nav-item"><a href="{{route('admin.area.management')}}" class="nav-link"><i class="fa fa-map"></i> Cek hasil survey</a></li>
							</ul>
						</li>
						<!-- <li class="nav-item nav-item-submenu">
...
@if(Route::currentRouteName() == 'admin.add_users')
<script>
	$(document).ready(function() {
		$('.form-steps').steps({
			headerTag: "h3",
...
@elseif(Route::currentRouteName() == 'admin.add.loan')
<script>
	$(document).ready(function() {
		$('.form-steps').steps({
			headerTag: "h3",
...
@elseif(Route::currentRouteName() == 'admin.loan.detail')
<script>
	$(document).ready(function() {
	...
	var val = $('#sisa_bayar_value').html();
	$('#sisa_bayar').val(val);
</script>
@elseif(Route::currentRouteName() == 'admin.approve.survey')
