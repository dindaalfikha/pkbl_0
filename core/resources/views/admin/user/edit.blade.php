...
<div class="content">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                <input type="number" maxlength="16" value="{{$client->no_ktp}}" name="no_ktp" class="form-control">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-form-label col-lg-2">Tanggal Lahir:</label>
                            <div class="col-lg-10">
                                <input type="date" value="{{date('Y-m-d', strtotime($client->tgl_lahir))}}" class="form-control" name="tgl_lahir" required>
                            </div>
                        </div> 
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                <select name="provinsi" id="provinsiEdit" class="custom-select">
                                    @foreach ($province as $item)
                                        <option value="{{$item->kode}}" @if($item->kode == $client->province) {{'selected'}} @endif>{{$item->nama}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>                        
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                <select name="kota" id="kotaEdit" class="custom-select">
                                    @foreach ($kota as $item)
                                        <option value="{{$item->kode}}" @if($item->kode == $client->city) {{'selected'}} @endif>{{$item->nama}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>                        
                ...
                <div class="card">
                    <div class="card-body text-center">
                        <div class="card-img-actions d-inline-block mb-3">
                            ...
                            <img class="img-fluid" src="{{url('/')}}/asset/ktp/{{$client->ktp}}" alt="">
                        </div>
                        <p class="text-center">Foto KTP</p>
                    </div>
                </div>
                <div class="card">
                    <div class="card-body">
        ...
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{$client->nama_kelompok}}" class="form-control" name="nama_kelompok">
                        </div>

                        <div class="form-group">
                            <label for="">Jumlah Anggota</label>
                            <input type="number" value="{{$client->jumlah_anggota}}" class="form-control" name="jumlah_anggota">
                        </div>
                        ...
                        <div class="form-group" id="usaha_container">
                            ...
                            <select name="jenis_usaha" id="usaha" class="custom-select">
                                ...
                                <option value="{{$value->id}}" @if($client->jenis_usaha == $value->id) {{'selected'}} @endif>{{$value->nama}}</option>
                                @endforeach
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_usaha" value="{{$client->nama_usaha}}"" class="form-control">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="sektor_usaha" id="" class="custom-select">
                                ...
                                <option value="{{$val->id}}" @if($client->sektor_usaha == $value->id) {{'selected'}} @endif>{{$val->nama}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select name="unit" class="custom-select">
                                ...
                                <option value="{{$val->id}}" @if($client->unit == $value->id) {{'selected'}} @endif>{{$val->nama}}</option>
                                @endforeach
                            </select>
                        </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body text-center">
                        <div class="card-img-actions d-inline-block mb-3">
                            <img class="img-fluid" src="{{url('/')}}/asset/ktp/{{$client->foto_usaha}}" alt="">
                        </div>
                        <p class="text-center">Foto Usaha</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    @if($client->kyc_status == 0)
    <a href="{{url('/')}}/admin/approve-kyc/{{$client->id}}" class="btn btn-success w-100 mb-3">Approve Identity</a>
    @endif
                        ...
                        <table class="table datatable-show-all">
                            ...
                            @foreach($loan as $k=>$val)
                                <tr>
                                    ...
                                    <td>{{$val->details}}</td>  
                                    <td>{{date("Y/m/d h:i:A", strtotime($val->tgl_kontrak))}}</td>
                                    <td class="text-center">
                                        <div class="list-icons">
                                            <div class="dropdown">
                                                <a href="#" class="list-icons-item" data-toggle="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    @if($val->status == 0)
                                                    <a href="{{url('/')}}/admin/loan-detail/{{$val->id}}/{{$val->user->id}}/2" class="dropdown-item"><i class="icon-eye mr-2"></i>Detail</a>
                                                    @elseif($val->status == 1)
                                                    <a href="{{url('/')}}/admin/loan-detail/{{$val->id}}/{{$val->user->id}}/0" class="dropdown-item"><i class="icon-eye mr-2"></i>Detail</a>
                                                    @elseif($val->status == 2)
                                                    <a href="{{url('/')}}/admin/loan-detail/{{$val->id}}/{{$val->user->id}}/1" class="dropdown-item"><i class="icon-eye mr-2"></i>Detail</a>
                                                    @else
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header header-elements-inline">
                    <h6 class="card-title font-weight-semibold">Sell Logs</h6>
                </div>
                <div class="">
                    <table class="table datatable-show-all">
                        <thead>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header header-elements-inline">
                    <h6 class="card-title font-weight-semibold">Buy Logs</h6>
                </div>
                <div class="">
                    <table class="table datatable-show-all">
                        <thead>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header header-elements-inline">
                    <h6 class="card-title font-weight-semibold">Exchange Logs</h6>
                </div>
                <div class="">
                    <table class="table datatable-show-all">
                        <thead>
