  ...
  <div class="content-wrapper">
    <div class="row">
          ...
          <div class="card-body">
            ...
            @csrf
                <div class="form-group row">
                  <label class="col-form-label col-lg-2">Old</label>
                  <div class="col-lg-10">
              ...
              <div class="form-group row">
                  <label class="col-form-label col-lg-2">New</label>
                  <div class="col-lg-10">
              ...
              <div class="form-group row">
                  <label class="col-form-label col-lg-2">Confirm</label>
                  <div class="col-lg-10">
      ...
      <div class="col-md-6">
        ...
        <div class="card">
          <div class="card-header header-elements-inline">
            <h3 class="mb-0">Change Pin <span>(Default pin on registration is <span class="text-primary">0000</span></span>)</h3>
          </div>
    ...
    <!-- <div class="row">
      <div class="col-lg-12">
        <div class="card bg-white">
          <div class="card-header header-elements-inline">
            <h3 class="mb-0">Two-Factor Security Option</h3>
          </div>
          <div class="card-body">
