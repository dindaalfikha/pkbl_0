        ...
        <div class="row align-items-center">
            <div class="col-lg-6 z100">
                <div class="backg-content">
                    ...
                    <!-- <a href="{{ url('https://api.whatsapp.com/send?phone=62895610052430')}}"></a>  -->
                </div>
                <!-- /.backg-content -->
            </div>
            <!-- /.col-lg-6 -->
            ...
            <div class="col-lg-6">
                <div class="wow soneFadeLeft">
                  ...
                  <div class="text-left">
                      <a href="{{route('register')}}"><span class="text-medium">Create new account?</span></a>
                    </div>                            
            ...
            <span class="text-medium">Visitor count : </a></span>             
                    <a href="{{route('counter')}}"></a> 
            <!-- /.col-lg-6 -->
        </div>
        <!-- /.row -->
    </div>
