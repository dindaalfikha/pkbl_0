...
<html class="no-js" lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{url('/')}}/asset/css/app.min.css" type="text/css">
            ...
            <div class="header-inner">
                ...
                <div class="navbar-mobile-logo">
                    <a href="{{route('home')}}" class="logo">
                        <img loading="lazy" src="{{url('/')}}/asset/{{$logo->image_link}}" alt="logo" class="main-logo"> 
                    </a>
                </div>
                ...
                <nav class="navbar-nav nav-dark">
                    ...
                    <div class="menu-wrapper" data-top="992">
                        <ul class="navbar-main-menu">
                            ...
                            <li><a href="{{route('about')}}" >Why {{$set->site_name}}</a></li>
...
<footer id="footer" class="wow soneFadeUp">
    <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-6">
                    <div class="widget footer-widget style_logo">
                        <!--<img loading="lazy" src="{{url('/')}}/asset/{{ $logo->image_link }}" alt="Logo">-->
                        <p>{{$set->site_desc}}</p>
        ...
        <div class="site-info">
            <div class="copyright">
                <p class="text-white">{{$set->site_name}}  &copy; {{date('Y')}}. All Rights Reserved. </p>
            </div>
        </div>
        <!-- /.site-info -->
    </div>
